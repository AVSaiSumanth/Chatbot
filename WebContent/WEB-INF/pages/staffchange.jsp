          ...
          <div class="container">
            ...
            <div class="navbar-collapse  collapse">
              <ul class="nav navbar-nav navbar-right">
               <li class=""><a href="staffhome.htm">Home</a></li>
                 <li class="active"><a href="staffchange.htm">Change Password</a></li>
...
<div class="row register">
 ...
 <form action="schangepassword.htm" method="post" onsubmit="return validate(this);">
...
<input type="hidden" name="opassword" value="${AuthUser.password }">
