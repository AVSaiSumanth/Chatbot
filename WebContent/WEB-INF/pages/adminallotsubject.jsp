...
$('#sem').change(
		function(event) {
			...
			var data = 'courseId='
					+ encodeURIComponent(courseId)+"&sem="+ encodeURIComponent(sem);
				
			$.ajax({
				url : "getcoursesubject.htm",
				data : data,
				contentType: 'application/json',
   				mimeType: 'application/json',
				...
				success : function(response) {
					$('#divSubject').css("display", "block"); 
						...
						$("#subjectId").empty().append('<option value="">Select Subject</option>');
											...
											var options="<option value='"+subjectId+"'>"+subjectName+"</option>";
...
<option value="${dept.deptId }">${dept.deptName }</option>
			...
			<!-- row  -->
			   ...
			   <div class="col-xs-3 col-md-3" align="right">
				<label for="concept" class="col-xs-4 col-md-3 control-label-left"><font color="red">*&nbsp;</font>Subject&nbsp;Name</label>
			   </div>
			   <div class="col-xs-5 col-md-6">
					<div class="form-group">
		...
		<input type="submit"  class="btn btn-success " value="Allot Subject">
