...
<div class="row register">
  <div class="col-lg-12 col-lg-offset-3 col-sm-12 col-sm-offset-3 col-xs-12 ">
 
<h2>Placements</h2>
<div class="rTable">
<div class="rTableRow">
<div class="rTableHead" style="width: 10%;"><strong>SNO</strong></div>
<div class="rTableHead"><span style="font-weight: bold;">Course Name</span></div>
...
<div class="rTableHead"><span style="font-weight: bold;">Company Name</span></div>
<div class="rTableHead"><span style="font-weight: bold;">Year</span></div>

</div>

<c:forEach var="plc" items="${placements }" varStatus="st">
<div class='rTableRow'>
				<div class='rTableCell' style="width: 10%;">${st.count }</div>
				<div class='rTableCell'>${plc.courseName}</div>
					<div class='rTableCell'>${plc.name}</div>
				<div class='rTableCell'>${plc.regNo}</div>
				<div class='rTableCell'>${plc.cname}</div>
				<div class='rTableCell'>${plc.year}</div>
...
<span class="glyphicon glyphicon-earphone"></span><p> 08554-242438</p>
            </div>
        </div>
