...
function my()
{
	$("#opc").show();
	 ...
	 $("#ans option[value=C]").show();
	  $("#ans option[value=D]").show();
	...
	if(v=="multiple")
	{
		...
		if(v=="tf")
		{
			  $("#ans option[value=C]").hide();
			  $("#ans option[value=D]").hide();
			 $("#opc").hide();
			 $("#opd").hide();
	...
	<!-- row  -->
			   ...
			   <div class="col-xs-5 col-md-6">
					<div class="form-group">
					   <select name="sectionType" id="sectionType" class="form-control"  required="required">
			   ...
			   <div class="col-xs-5 col-md-6">
					<div class="form-group">
					   <select name="quetionType" id="quetionType" class="form-control" onchange="my()" required="required">
			   ...
			   <div class="col-xs-5 col-md-6">
					<div class="form-group">
					   <textarea rows="5" cols="20" name="c"  id="c" required  class="form-control" placeholder="Option C"></textarea>
			   ...
			   <div class="col-xs-5 col-md-6">
					<div class="form-group">
					   <textarea rows="5" cols="20" name="d" id="d"   required  class="form-control" placeholder="Option D"></textarea>
			   ...
			   <div class="col-xs-5 col-md-6">
					<div class="form-group">
					   <select name="nmarks" id="nmarks" class="form-control" required="required">
