...
<div class="row register">
  ...
  <form method="post" action="adminaddsubject.htm">
...
<option value="${course.courseId }">${course.courseName }</option>
			   ...
			   <div class="col-xs-3 col-md-3" align="right">
				<label for="concept" class="col-xs-4 col-md-1 control-label-left"><font color="red">*&nbsp;</font>SubjectName</label>
			   </div>
			   <div class="col-xs-5 col-md-6">
					<div class="form-group">
			...
			<!-- row  -->
			   ...
			   <div class="col-xs-3 col-md-3" align="right">
				<label for="concept" class="col-xs-4 col-md-1 control-label-left"><font color="red">*&nbsp;</font>Title</label>
			   </div>
			   <div class="col-xs-5 col-md-6">
					<div class="form-group">
