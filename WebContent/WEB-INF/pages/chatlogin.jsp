...
<div class="row register">
  ...
  <form method="post" action="chatlogin.htm">
 <div style = "font-size:11px; color:#cc0000; margin-top:10px">${errMsg }</div>

                <input required type="text" class="form-control" placeholder="Enter your name" name="username">
               
             <input required type="email" class="form-control" placeholder="Enter your EmailId" name="emailid">
