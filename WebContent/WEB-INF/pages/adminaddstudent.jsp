...
<option value="${course.courseId }">${course.courseName }</option>
			...
			<!-- row  -->
			  ...
			  <!-- row  -->
			   ...
			   <div class="col-xs-3 col-md-3" align="right">
				<label for="concept" class="col-xs-4 col-md-1 control-label-left"><font color="red">*&nbsp;</font>Grade</label>
			   </div>
			   <div class="col-xs-5 col-md-6">
					<div class="form-group">
			   ...
			   <div class="col-xs-3 col-md-3" align="right">
				<label for="concept" class="col-xs-4 col-md-1 control-label-left"><font color="red">*&nbsp;</font>Total No.of classes</label>
			   </div>
			   <div class="col-xs-5 col-md-6">
					<div class="form-group">
					   <input type="number" class="form-control" name="totalNoofClasses" id="totalNoofClasses" required>
			   ...
			   <div class="col-xs-3 col-md-3" align="right">
				<label for="concept" class="col-xs-4 col-md-1 control-label-left"><font color="red">*&nbsp;</font>Total No.of Attented classes</label>
			   </div>
			   <div class="col-xs-5 col-md-6">
					<div class="form-group">
					   <input type="number" class="form-control" name="totalNoofClassesAtten" id="totalNoofClassesAtten" required>
