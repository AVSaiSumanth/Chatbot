		...
		<div class="spacer">
			<div class="row register">
				<div
					...
					<form method="post" action="addact.htm">

						<div style="font-size: 11px; color: #cc0000; margin-top: 10px"></div>

						<input type="text" class="form-control"
							placeholder="Activity Name" name="activityName" required>
						<textarea required class="form-control" placeholder="Remarks"
							name="remarks"></textarea>
						<input type="date" class="form-control"
							placeholder="Date Of Conducted" name="dateOfConducted" required>
					...
					<div class="rTable">
						<div class="rTableRow">
							...
							<div class="rTableHead">Remark</div>
							<div class="rTableHead">Date Of Conducted</div>
						</div>

						<c:forEach var="activity" items="${activitys }" varStatus="st">
							<div class='rTableRow'>
								<div class='rTableCell'>${st.count }</div>
								<div class='rTableCell'>${activity.activityName }</div>
								<div class='rTableCell'>${activity.remarks }</div>
								<div class='rTableCell'>${activity.dateOfConducted }</div>
