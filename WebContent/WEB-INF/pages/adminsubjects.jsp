...
<div class="rTableHead"><span style="font-weight: bold;">SubjectName</span></div>
<div class="rTableHead"><span style="font-weight: bold;">Title</span></div>
<div class="rTableHead"><span style="font-weight: bold;">Sem</span></div>

</div>

<c:forEach var="subject" items="${subjects }" varStatus="st">
<div class='rTableRow'>
				<div class='rTableCell' style="width: 10%;">${st.count }</div>
				<div class='rTableCell'>${subject.name}</div>
				<div class='rTableCell'>${subject.title}</div>
				<div class='rTableCell'>${subject.semester}</div>
