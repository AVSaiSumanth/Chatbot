          ...
          <div class="container">
            ...
            <div class="navbar-collapse  collapse">
              <ul class="nav navbar-nav navbar-right">
               <li class=""><a href="studenthome.htm">Home</a></li>
                <li class="active"><a href="studentchange.htm">Change password</a></li>
...
<form action="changepassword.htm" method="post" onsubmit="return validate(this);">
		<input type="password" class="form-control" placeholder="Old Password" name="oldPassword">
 
  
                <input type="password" class="form-control" placeholder="New Password" name="password">
                 <input type="password" class="form-control" placeholder="New Passord Confirm" name="cpassword">
                  
<input type="hidden" name="opassword" value="${AuthStudent.password }">
...
<script type="text/javascript">
		function  validate(formObj)
		{
			...
			var valid=true;
			if(formObj.opassword.value!=formObj.oldPassword.value)
			{
				valid=false;
				alert("Invalid password");
				
			}
			else if(formObj.cpassword.value!=formObj.password.value)
			{
				valid=false;
				alert("mismath password and confirm password");
			}
