...
<html lang="en">
<head>
<title>Admin Add Placements </title>
<meta charset="UTF-8" />
...
<div class="row register">
  ...
  <form method="post" action="adminaddplacement.htm">
...
<option value="${course.courseName }">${course.courseName }</option>
			...
			<!-- row  -->
			   ...
			   <div class="col-xs-3 col-md-3" align="right">
				<label for="concept" class="col-xs-4 col-md-1 control-label-left"><font color="red">*&nbsp;</font>Company Name</label>
			   </div>
			   <div class="col-xs-5 col-md-6">
					<div class="form-group">
			  ...
			  <!-- row  -->
			   ...
			   <div class="col-xs-3 col-md-3" align="right">
				<label for="concept" class="col-xs-4 col-md-1 control-label-left"><font color="red">*&nbsp;</font>Year</label>
			   </div>
			   <div class="col-xs-5 col-md-6">
					<div class="form-group">
			   ...
			   <div class="col-xs-3 col-md-3" align="right">
				<label for="concept" class="col-xs-4 col-md-1 control-label-left"><font color="red">*&nbsp;</font>CTC</label>
			   </div>
			   <div class="col-xs-5 col-md-6">
					<div class="form-group">
