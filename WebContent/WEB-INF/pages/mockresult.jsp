...
<body onload="startTime()">
	...
	<div class="container">
		<div class="spacer">
			...
			<form action="submitmockexam.htm" method="post">
				<%
					int count = 0;
				%>
					...
					<div class="row" id="div<%=++count%>">
						<div
							...
							<div class="row">
								<div
									...
									<strong> <%=count%>)&nbsp;${ques.quationTitle }
									</strong> <input type="hidden" name="q<%=count%>" value="${ques.qid }" />
						...
						<div class="row">
									...
									<div class="row">
										...
										<div class="grow"  align="left">
										Show answer
										<div
											class="col-lg-6 col-lg-offset-2 col-sm-6 col-sm-offset-3 col-xs-12 ">
											      ${ques.ans }
