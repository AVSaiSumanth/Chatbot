...
<div class="row register">
  <div class="col-lg-9 col-lg-offset-1 col-sm-9col-sm-offset-1 col-xs-12 ">
 
<h2>Faculty</h2>
<div class="rTable">
<div class="rTableRow">
<div class="rTableHead" style="width: 9%;"><strong>SNO</strong></div>
<div class="rTableHead"><span style="font-weight: bold;">DeptName</span></div>

<div class="rTableHead">FacultyName</div>
<div class="rTableHead">Designation</div>
<div class="rTableHead" style="width: 9%;">Delete</div>

</div>

<c:forEach var="fac" items="${users }" varStatus="st">
<div class='rTableRow'>
			<div class='rTableCell' style="width: 9%;">${st.count }</div>
			<div class='rTableCell'>${fac.deptName }</div>
		
			<div class='rTableCell'>${fac.firstName }${fac.lastName }</div>
			<div class='rTableCell'>${fac.desg }</div>
			<div class='rTableCell' style="width: 9%;"><a href="deletefac.htm?fid=${fac.userId }">Delete</a></div>
