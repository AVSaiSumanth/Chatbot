...
<div class="row register">
  ...
  <form method="post" action="adminaddcourses.htm">
...
<option value="${dept.deptId }">${dept.deptName }</option>
			   ...
			   <div class="col-xs-3 col-md-3" align="right">
				<label for="concept" class="col-xs-4 col-md-1 control-label-left"><font color="red">*&nbsp;</font>CourseName</label>
			   </div>
			   <div class="col-xs-5 col-md-6">
					<div class="form-group">
			...
			<!-- row  -->
			   ...
			   <div class="col-xs-3 col-md-3" align="right">
				<label for="concept" class="col-xs-4 col-md-1 control-label-left"><font color="red">*&nbsp;</font>CourseCode</label>
			   </div>
			   <div class="col-xs-5 col-md-6">
					<div class="form-group">
			   ...
			   <div class="col-xs-3 col-md-3" align="right">
				<label for="concept" class="col-xs-4 col-md-1 control-label-left"><font color="red">*&nbsp;</font>CourseDescription</label>
			   </div>
			   <div class="col-xs-5 col-md-6">
					<div class="form-group">
					   <textarea class="form-control" name="descr" id="descr" required></textarea>
