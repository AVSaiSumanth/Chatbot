          ...
          <div class="container">
            ...
            <div class="navbar-collapse  collapse">
              <ul class="nav navbar-nav navbar-right">
               ...
               <li class="active"><a href="admindept.htm">Departments</a></li>
			    <li class="dropdown">
...
<div class="row register">
 ...
 <div style = "font-size:11px; color:#cc0000; margin-top:10px"></div>
                ...
                <input type="text" class="form-control" placeholder="Dept Name" name="deptName" required>
				  <textarea required  class="form-control" placeholder="Dept Description" name="deptDescription"  ></textarea>
...
<div class='rTableRow'>
			...
			<div class='rTableCell'>${dept.deptDescription }</div></div>
