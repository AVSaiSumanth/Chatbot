...
<div class="spacer">
 <!-- row  -->
			   ...
			   <div class="col-xs-2 col-md-2" align="right">
				<label for="concept" class="col-xs-2 col-md-2 control-label-left">QuestionTitle</label>
			   </div>
			   <div class="col-xs-2 col-md-2">
					<div class="form-group">
					 ${requestScope.question.quationTitle }
			   ...
			   <div class="col-xs-2 col-md-2" align="right">
				<label for="concept" class="col-xs-2 col-md-2 control-label-left">Optio&nbsp;A</label>
			   </div>
			   <div class="col-xs-2 col-md-2">
					<div class="form-group">
					 ${requestScope.question.a }
			   ...
			   <div class="col-xs-2 col-md-2" align="right">
				<label for="concept" class="col-xs-2 col-md-2 control-label-left">Option&nbsp;B</label>
			   </div>
			   <div class="col-xs-2 col-md-2">
					<div class="form-group">
					 ${requestScope.question.b }
			   ...
			   <div class="col-xs-2 col-md-2" align="right">
				<label for="concept" class="col-xs-2 col-md-2 control-label-left">Option&nbsp;C</label>
			   </div>
			   <div class="col-xs-2 col-md-2">
					<div class="form-group">
					 ${requestScope.question.c }
			   ...
			   <div class="col-xs-2 col-md-2" align="right">
				<label for="concept" class="col-xs-2 col-md-2 control-label-left">Option&nbsp;D</label>
			   </div>
			   <div class="col-xs-2 col-md-2">
					<div class="form-group">
					 ${requestScope.question.d }
			   ...
			   <div class="col-xs-2 col-md-2" align="right">
				<label for="concept" class="col-xs-2 col-md-2 control-label-left">Ansewr</label>
			   </div>
			   <div class="col-xs-2 col-md-2">
					<div class="form-group">
					 ${requestScope.question.ans }
