            ...
            <div class="navbar-collapse  collapse">
			 ...
			 <li class="dropdown">
				 ...
				 <li class="dropdown">
				  ...
				  <ul class="dropdown-menu active">
					<li class="kopie"><a href="adminfacultytt.htm">TimeTable</a></li>
					<li class="kopie"><a href="adminaddfacultytt.htm">AddTimeTable</a></li>
					</ul>
				</li>
				<li class="dropdown">
				  <a href="#" class="dropdown-toggle" data-toggle="dropdown">Reports <b class="caret"></b></a> 
				  <ul class="dropdown-menu active">
					<li class="kopie"><a href="adminreports.htm">All Reports </a></li>
					<li class="kopie"><a href="adminfacreport.htm">Faculty Reports
...
<div class="rTableHead">FacultyId</div>
...
<div class='rTableRow'>
			...
			<div class='rTableCell'>${fac.facultyCode }</div>
